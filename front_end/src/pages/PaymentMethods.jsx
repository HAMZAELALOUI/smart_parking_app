    ...
    <div className="max-w-4xl mx-auto my-10 bg-white shadow-md rounded-lg p-8">
      ...
      {selectedPaymentMethod && (
        <div className="text-center mt-10">
          <button
            onClick={openModal}
            className="bg-green-600 hover:bg-green-800 text-white font-bold py-3 px-6 rounded-lg transition duration-200"
          >
...
function PaymentOption({ method, Icon, onSelect, isSelected }) {
  return (
    <div
      className={`p-4 border ${isSelected ? 'border-blue-500' : 'border-gray-300'} rounded-lg cursor-pointer flex flex-col items-center space-y-4`}
      onClick={onSelect}
    >
