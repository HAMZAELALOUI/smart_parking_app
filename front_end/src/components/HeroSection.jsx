        ...
        <div className="px-4 py-12 bg-cover bg-center" style={{ backgroundImage: `url(/assets/1.jpg)` }}>
            <div className="container mx-auto text-center bg-white bg-opacity-80 rounded-lg p-6">
                ...
                <div className="space-x-4 mb-6">
                    ...
                    <button className="text-lg px-6 py-2 border border-gray-300 shadow-sm rounded-full text-gray-800 bg-white hover:bg-green-500 hover:text-white">Airport</button>
                </div>
                <div className="max-w-md mx-auto flex flex-col items-center gap-4">
                    <input type="text" placeholder="Enter a place or postcode" className="form-input px-4 py-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-green-500" />
                    ...
                    <button className="bg-green-500 text-white px-6 py-2 rounded-md w-full">Show parking spaces</button>
                </div>
            </div>
        </div>
    );
